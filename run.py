...
app = Flask(__name__)
access_token = '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'
...
##        DBConnector().storeRepositoryInformation(data)
...
##        DBConnector().storeSelectedLabels(selectedLabels)
...
def submitForm():
    ...
    # DBConnector().storeSelectedDayTime(selectedDayTime)
